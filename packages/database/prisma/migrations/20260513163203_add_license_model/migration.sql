...
-- CreateIndex
CREATE INDEX "device_activation_licenseId_idx" ON "device_activation"("licenseId");

-- CreateIndex
CREATE INDEX "device_activation_licenseId_deviceFingerprint_idx" ON "device_activation"("licenseId", "deviceFingerprint");

-- CreateIndex
CREATE INDEX "device_activation_licenseId_deactivatedAt_idx" ON "device_activation"("licenseId", "deactivatedAt");
...
-- AddForeignKey
ALTER TABLE "device_activation" ADD CONSTRAINT "device_activation_licenseId_fkey" FOREIGN KEY ("licenseId") REFERENCES "license"("id") ON DELETE CASCADE ON UPDATE CASCADE;
