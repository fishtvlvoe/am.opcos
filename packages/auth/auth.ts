...
export const auth = betterAuth({
	...
	emailAndPassword: {
		...
		autoSignIn: process.env.REQUIRE_EMAIL_VERIFICATION === "false" || !config.enableSignup,
		requireEmailVerification: process.env.REQUIRE_EMAIL_VERIFICATION !== "false" && config.enableSignup,
	...
	emailVerification: {
		sendOnSignUp: process.env.REQUIRE_EMAIL_VERIFICATION !== "false" && config.enableSignup,
